...
\begin{document}
	...
	\begin{teorema}\label{sur}
		Za svako $k \in \mathbb{N}\textbackslash \{0\}$  postoji neko $n \in \mathbb{N}$, takvo da za svako bojenje $\chi:\underline{n} \rightarrow \underline{k}$ postoje brojevi $x, y, z \in \underline{n}$ sa osobinom 
		\[
	...
	\begin{thebibliography}{99}
		...
		\bibitem{Uzastopni Remzijevi brojevi}
		S. A. Burr, P. Erdos, R. J. Faudree, R.H. Schelp
		\newblock{On the Diffeence of Consecutive Ramsey Numbers} 		
