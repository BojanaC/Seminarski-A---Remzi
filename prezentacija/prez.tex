...
\frame{
	...
	\begin{definicija}
		...
		\]
		ako za svako bojenje $\chi:[\underline{n}]^k$ postoje $i\in \underline{r}$ i $T\subseteq \underline{n}$ sa $|T|=l_i$, takvi da je $[T]^k$ u odnosu na $\chi$ $i$-monohromatsko.	
	\end{definicija}
	...
	\begin{definicija}
		...
		n\rightarrow(l_1,\ldots,l_r)^k
		\]
		naziva se Remzijev broj i označavamo ga sa $R_k(l_1,\ldots,l_r)$.
	\end{definicija}
}
\frame{
